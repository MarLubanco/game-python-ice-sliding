...
def setup_room_1():
    ...
    room.wall_final_list = arcade.SpriteList()
    ...
    coordinate_final = [[16 * SPRITE_SIZE, 6 * SPRITE_SIZE],
                       [16 * SPRITE_SIZE, 5 * SPRITE_SIZE]]

    for coordinate in coordinate_final:
        wall = arcade.Sprite("images/ice_block.png", SPRITE_SCALING)
        wall.left = coordinate[0]
        wall.bottom = coordinate[1]
        room.wall_final_list.append(wall)
...
class MyGame(arcade.Window):
    def __init__(self, width, height, title):
        ...
        self.collision_final_list = None
        self.controle = False
    ...
    def setup(self):
        ...
        self.collision_final_list = arcade.SpriteList()
        self.collision_final_list = self.rooms[self.current_room].wall_final_list
    ...
    def on_draw(self):
        ...
        if self.controle == True:
            start_x = (SCREEN_HEIGHT / 2) - 90
            start_y = SCREEN_WIDTH / 2
            arcade.draw_point(start_x, start_y, arcade.color.BLUE, 5)
            arcade.draw_text("Winner", start_x, start_y, arcade.color.YELLOW, 100)
            arcade.draw_text("Reset click 'R'", start_x + 110, start_y - 30, arcade.color.BLACK, 20)
    ...
    def update(self, delta_time):
        ...
        self.collision_final_list.update()
        ...
        if len(arcade.check_for_collision_with_list(self.player_sprite, self.collision_final_list)) > 0:
            self.controle = True
            self.player_sprite.center_x -= MOVEMENT_SPEED
            self.player_sprite.change_x = 0
